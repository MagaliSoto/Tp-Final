...
class FormGameLevel3(Form):
    def __init__(self,name,master_surface,x,y,w,h,active):
        ...
        self.static_background = Background(x=0,y=0,width=w,height=h,path="images/locations/nivel3.png")
    ...
    def reset(self):
        ...
        self.plataform_list.append(Plataform(x=250,y=550,width=50,height=50,type=0))
        ...
        self.plataform_list.append(Plataform(x=100,y=270,width=50,height=50,type=0))
        self.plataform_list.append(Plataform(x=150,y=270,width=50,height=50,type=1))
        self.plataform_list.append(Plataform(x=200,y=270,width=50,height=50,type=1))
        self.plataform_list.append(Plataform(x=250,y=270,width=50,height=50,type=1))
        self.plataform_list.append(Plataform(x=300,y=270,width=50,height=50,type=2)) 
        
        self.plataform_list.append(Plataform(x=400,y=450,width=50,height=50,type=12))
        self.plataform_list.append(Plataform(x=450,y=450,width=50,height=50,type=13))    
        self.plataform_list.append(Plataform(x=500,y=450,width=50,height=50,type=13))
        self.plataform_list.append(Plataform(x=550,y=450,width=50,height=50,type=14))
        
        self.plataform_list.append(Plataform(x=650,y=200,width=50,height=50,type=12))
        self.plataform_list.append(Plataform(x=700,y=200,width=50,height=50,type=14))
        
        self.plataform_list.append(Plataform(x=800,y=250,width=50,height=50,type=12))
        self.plataform_list.append(Plataform(x=850,y=250,width=50,height=50,type=14))

        self.plataform_list.append(Plataform(x=950,y=450,width=50,height=50,type=12))
        self.plataform_list.append(Plataform(x=1000,y=450,width=50,height=50,type=14))

        self.plataform_list.append(Plataform(x=1100,y=500,width=50,height=50,type=0))
        self.plataform_list.append(Plataform(x=1150,y=500,width=50,height=50,type=1)) 
        self.plataform_list.append(Plataform(x=1200,y=500,width=50,height=50,type=2))

        self.plataform_list.append(Plataform(x=850,y=350,width=50,height=50,type=12))
        self.plataform_list.append(Plataform(x=900,y=350,width=50,height=50,type=14)) 
        ...
        self.monedas_lista.append(Moneda(x=420,y=400,width=30,height=30))
        self.monedas_lista.append(Moneda(x=490,y=400,width=30,height=30))
        self.monedas_lista.append(Moneda(x=550,y=400,width=30,height=30))

        self.monedas_lista.append(Moneda(x=825,y=200,width=30,height=30))

        self.monedas_lista.append(Moneda(x=875,y=300,width=30,height=30))

        self.monedas_lista.append(Moneda(x=975,y=400,width=30,height=30))

        self.monedas_lista.append(Moneda(x=1100,y=450,width=30,height=30))
        self.monedas_lista.append(Moneda(x=1150,y=450,width=30,height=30))
        self.monedas_lista.append(Moneda(x=1200,y=450,width=30,height=30))
        ...
        self.enemy_list = []
        self.tumbas_list = []
        self.tumbas_list_tuplas = []  

        self.tumbas_list_tuplas = [(300,550),(200,270),(475,450),(825,250),
                                   (975,450),(1150,500),(875,350)]

        self.generatorTumba = TumbaGenerator(self.tumbas_list_tuplas, tiempo_ataque=3000, cantidad_tumbas=3)

        self.generator = EnemyGenerator(x_range=(50,1250),y_range=(50, 500),speed_range=(1.0, 3.0),shoot_interval_range=(3000,10000),ruta_camina="images/caracters/enemies/enemigo esqueleto.png",columnas_camina=6,gravity=14,puntaje=30,cantidad_enemigos=3)
        ...
        for _ in range(3):
            tumba = self.generatorTumba.generate_tumba()
            self.tumbas_list.append(tumba)
        ...
        self.bandera = bandera(690,150,50,50)
        ...
        self.boton1 = Button(master=self,x=570,y=-2,w=240,h=105,image_background="images/gui/botones/botonNivel3.png",on_click=self.on_click_boton1,on_click_param="menuPausa")
    ...
    def update(self,lista_eventos,keys,delta_ms):
        ...
        for tumba in self.tumbas_list:
            tumba.update(delta_ms,self.plataform_list)
            if(self.player_1.rect.colliderect(tumba.rect)):
        ...
        self.generatorTumba.update(delta_ms,self.tumbas_list)
